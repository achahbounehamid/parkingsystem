...
//    public static final String GET_TICKET = "SELECT t.ID, t.PARKING_NUMBER, t.VEHICLE_REG_NUMBER, t.PRICE, t.IN_TIME, t.OUT_TIME, " +
//            "p.PARKING_TYPE, p.AVAILABLE " +
//            "FROM ticket t " +
//            "JOIN parking_spot p ON t.PARKING_NUMBER = p.ID " +
